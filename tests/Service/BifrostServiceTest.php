...
class BifrostServiceTest extends SapphireTest
{
    ...
    public function testEnvironmentizeIndex(): void
    {
        ...
        /** @var IndexingInterface|BifrostService $indexer */
    ...
    public function testValidateIndex(): void
    {
        ...
        // This method is private, so we need Reflection to access it
        $reflectionMethod = new ReflectionMethod(BifrostService::class, 'validateIndex');
        $reflectionMethod->setAccessible(true);
    ...
    public function testFetchEngines(): void
    {
        ...
        // This method is private, so we need Reflection to access it
        $reflectionMethod = new ReflectionMethod(BifrostService::class, 'fetchEngines');
        $reflectionMethod->setAccessible(true);
    ...
    public function testFindOrMakeExists(): void
    {
        ...
        // This method is private, so we need Reflection to access it
        $reflectionMethod = new ReflectionMethod(BifrostService::class, 'findOrMakeIndex');
        $reflectionMethod->setAccessible(true);
    ...
    public function testConfigureNewField(): void
    {
        ...
        // Second Response body should be the new Schema after the requested change has been made by the Bifrost
        $secondBody = [
            'title' => 'text',
            'html_text' => 'text',
            'first_name' => 'text',
    ...
    protected function setUp(): void
    {
        ...
        $this->searchService = BifrostService::create($elasticClient, $indexConfiguration, $documentBuilder);
    }
